...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../styles/index.css */ \"./styles/index.css\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ \"./src/utils.js\");\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== \"undefined\" && arr[Symbol.iterator] || arr[\"@@iterator\"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\n/** @jsx createElement */\n\n\n\nvar Raccoonact = function () {\n  var hooks = [];\n  var idx = 0;\n\n  function workLoop() {\n    idx = 0;\n    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.render)(hooks)();\n    setTimeout(workLoop, 300);\n  }\n\n  setTimeout(workLoop, 300);\n\n  function useState(initVal) {\n    var state = hooks[idx] || initVal;\n    var _idx = idx;\n\n    var setState = function setState(newVal) {\n      hooks[_idx] = newVal;\n    };\n\n    idx++;\n    return [state, setState];\n  }\n\n  function useRef(val) {\n    return useState({\n      current: val\n    })[0];\n  }\n\n  function useEffect(cb, depArray) {\n    var oldDeps = hooks[idx];\n    var hasChanged = true;\n\n    if (oldDeps) {\n      hasChanged = depArray.some(function (dep, i) {\n        return !Object.is(dep, oldDeps[i]);\n      });\n    }\n\n    if (hasChanged) cb();\n    hooks[idx] = depArray;\n  }\n\n  return {\n    useState: useState,\n    render: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.render)(hooks),\n    useEffect: useEffect,\n    useRef: useRef,\n    createElement: _utils__WEBPACK_IMPORTED_MODULE_1__.createElement\n  };\n}();\n\nfunction Component() {\n  var _Raccoonact$useState = Raccoonact.useState(1),\n      _Raccoonact$useState2 = _slicedToArray(_Raccoonact$useState, 2),\n      count = _Raccoonact$useState2[0],\n      setCount = _Raccoonact$useState2[1];\n\n  return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.createElement)(\"main\", null, (0,_utils__WEBPACK_IMPORTED_MODULE_1__.createElement)(\"h1\", null, \"This is \", (0,_utils__WEBPACK_IMPORTED_MODULE_1__.createElement)(\"i\", null, \"Not\"), \" Raccoonact\"), (0,_utils__WEBPACK_IMPORTED_MODULE_1__.createElement)(\"button\", {\n    onClick: function onClick() {\n      return setCount(count + 1);\n    }\n  }, \"Click me!!!! \", count));\n} // var app = Raccoonact.render(Component);\n// app.click();\n// var app = Raccoonact.render(Component);\n// app.type(\"Vue\");\n// var app = Raccoonact.render(Component);\n\n\nvar rootElement = document.getElementById('root');\nRaccoonact.render((0,_utils__WEBPACK_IMPORTED_MODULE_1__.createElement)(Component, null), rootElement);\n\n//# sourceURL=webpack://gittoorami/./src/index.js?");
